...
> jardisadapter/cache | NS: `JardisAdapter\Cache` | PSR-16 v3.0 multi-layer | PHP 8.2+
...
| Exception | Trigger |
|-----------|---------|
| `JardisAdapter\Cache\Exception\InvalidArgumentException` | Empty/whitespace key in `hash()` |
