...
use JardisAdapter\Cache\Exception\InvalidArgumentException;
...
class AbstractCacheTest extends TestCase
{
    ...
    public function testNegativeTtlDeletesItem(): void
    {
        // Pre-set a value
        $this->cache->set('key', 'value');
        $this->assertTrue($this->cache->has('key'));

        // Negative TTL must delete the item (PSR-16)
    ...
    public function testZeroTtlDeletesItem(): void
    {
        ...
        // Zero TTL must delete the item (PSR-16)
